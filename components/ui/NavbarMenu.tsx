...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative sm:rounded-full rounded-0 border border-transparent bg-black sm:border-white/[0.2] shadow-input flex justify-center space-x-8 px-8 py-6 "
    >
